...
public class Settings : MonoBehaviour
{
    ...
    public void Olustur()
    {
        ...
        {
            StartCoroutine(Post("https://appjam.inseres.com/servicekelimeoyunu/Service/CreateOnlineRoom", processJson(RoomNameText,GlobalKullanıcıBilgileri._OyuncuIsim, PrivatePublicButton, TimeButton, NumberOfPeople, PointType, TimeBreak))); ;
        }
    }

    ...
    public void ControlTypeRoom(GameObject obj)
    {
        ...
        { 
            ...
            if (RoomType.GetComponent<Text>().text == "Herkese Açık")
            {
                ...
                StartCoroutine(Post("https://appjam.inseres.com/servicekelimeoyunu/Service/JoinRoom", processJson(GlobalKullanıcıBilgileri._OyuncuIsim, GlobalKullanıcıBilgileri._Room_key)));
            }
            else
            {
